  ...
  invoices: [
    {
      ...
      dueDate: '2026-08-30',
      items: [
        { id: 'itm-1', description: 'Design System Architecture & Tokens', quantity: 20, unitPrice: 75, amount: 1500 },
        { id: 'itm-2', description: 'Responsive Marketing Page Templates', quantity: 30, unitPrice: 75, amount: 2250 },
      ],
      subtotal: 3750,
      taxPercent: 5,
      taxAmount: 187.5,
    ...
    },
    {
      ...
      dueDate: '2026-09-15',
      items: [
        { id: 'itm-3', description: 'Crypto Portfolio Charts & Telemetry', quantity: 40, unitPrice: 90, amount: 3600 },
        { id: 'itm-4', description: 'Security & Key Encryption UI Flow', quantity: 20, unitPrice: 90, amount: 1800 },
      ],
      subtotal: 5400,
      taxPercent: 0,
      taxAmount: 0,
